...
raw_data <- read.csv(url("https://vivianchiou.github.io/shiny_web/data/covid_19_data.csv"), stringsAsFactors = FALSE)
...
# library(htmltools)
df_open_line_list <- read.csv(url("https://vivianchiou.github.io/shiny_web/data/COVID19_open_line_list.csv"), encoding = "UTF-8" , stringsAsFactors = FALSE)
...
df_map$longitude = as.double(df_open_line_list$longitude)
df_map$latitude = as.double(df_open_line_list$latitude)

df_map = df_map %>% 
  filter(df_map$longitude %inrange% range(-180:180) & latitude %inrange% range(-90:90)) %>%
